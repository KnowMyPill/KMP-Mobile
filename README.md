...
The <b>Google Solution Challenge</b> is designed to encourage participants to develop solutions that address one or more of the United Nations Sustainable Development Goals (SDGs). These 17 goals cover a broad range of social and economic development issues.
<br><br>
...
As part of the GDSC Google Solution Challenge, <b>PillKaBoo(Team Parkour)</b> tackles the following UN SDGs.
<br><br>
<div align="center" >
...
## 📼 Demo Video
[![PillKaBoo Demo Video](https://github.com/becooq81/PillKaBoo-HomePage/blob/main/assets/Video.jpg)](https://youtu.be/22VUkDcbuaw?si=BbDLXNQvpYAJmj70)

> **Video Link**: _[YouTube @parkour.official](https://youtu.be/22VUkDcbuaw?si=BbDLXNQvpYAJmj70)_
